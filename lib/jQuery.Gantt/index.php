...
function getCalendarData ($id) {
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        ...
        $newDate1 = date("d/m/y", strtotime($harvest_date));  
        // echo "<br>New date format is: ".$newDate. " (DD/MM/YYYY)<br>";  
        ?>
        {

                desc: "<?php echo getAreaDataById($row['area_id'])['name']; ?>",
                values: [{
                    from: <?php echo strtotime($start_date)*1000; ?>,
                    to: <?php echo strtotime($harvest_date)*1000; ?>,
                    label: "<?php echo getAreaDataById($row['area_id'])['name']; ?>",
...
getCalendarData ("3"); echo ("<br>");
// print_r(getAreaDataById("2")); echo "<br>";
...
values: [
    ...
    <a href="https://github.com/taitems/jQuery.Gantt" class="github-corner" aria-label="View source, download, or contribute on GitHub" title="View source, download, or contribute on GitHub">
    ...
    <script>
        $(function() {
            ...
            var demoSource = [<?php getCalendarData ("1"); getCalendarData ("2"); getCalendarData ("3"); getCalendarData ("4"); ?>];
